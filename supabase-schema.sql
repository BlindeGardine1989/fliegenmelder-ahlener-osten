-- Supabase SQL Editor öffnen und alles ausführen.
...
-- Für Admin-Freigabe später Supabase Auth aktivieren.
-- Startvariante: Meldungen direkt in Supabase Tabelle reports freigeben:
